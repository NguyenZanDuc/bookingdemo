...
const index = (props: Props) => {
  return (
    <div className="relative z-0 w-full ">
        <img src='/heroImage.jpeg' alt='hero' className="object-fill brightness-50"/>
        <div className="absolute flex flex-col justify-center gap-5 text-white top-1/2 left-20">
            ...
            <div>
                <Button variant="contained" color="primary" className="bg-[#003A62]" >Tìm Ưu Đãi Mùa Du Lịch</Button>
            </div>
        </div>
