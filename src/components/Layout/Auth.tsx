    ...
    <>
      {user?(
            <div className="flex items-center justify-center gap-2">
                ...
                <Button variant="outlined"><a href="#" className="text-[#57B9FF]">Đăng nhập</a></Button>
            </div>
        ):(
            <div className="flex items-center justify-center gap-2 p-2 hover:bg-white hover:bg-opacity-10 rounded-xl">
